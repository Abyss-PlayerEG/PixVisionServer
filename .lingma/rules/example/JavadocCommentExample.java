 ...
 * @see top.playereg.pix_vision.util.LogAspect 日志记录切面实现
...
public @interface LogRecord {
     ...
     * 操作模块名称
     * <p>
     * 用于标识操作所属的业务模块，便于日志分类和统计。
     * 建议使用统一的模块名称，如"用户管理"、"作品管理"、"系统配置"等。
     * </p>
     *
     * <h3>使用示例</h3>
     * <pre>{@code
     * @LogRecord(module = "用户管理", event = "修改昵称")
     * @LogRecord(module = "作品管理", event = "发布作品")
     * @LogRecord(module = "系统配置", event = "清理缓存")
     * }</pre>
     *
     * @return 模块名称字符串
     */
     ...
     * 操作事件描述
     * <p>
     * 用于描述具体的操作行为，应该简洁明确地说明做了什么操作。
     * 建议格式为"动词 + 名词"，如"修改昵称"、"删除作品"、"封禁用户"等。
     * </p>
     *
     * <h3>使用示例</h3>
     * <pre>{@code
     * @LogRecord(module = "用户管理", event = "修改昵称")
     * @LogRecord(module = "用户管理", event = "修改密码")
     * @LogRecord(module = "作品管理", event = "批量删除作品")
     * @LogRecord(module = "用户管理", event = "封禁用户")
     * }</pre>
     *
     * <h3>注意事项</h3>
     * <ul>
     *   <li>事件描述应该简洁明了，避免过长</li>
     *   <li>使用统一的动词，便于后续统计分析</li>
     *   <li>对于批量操作，应该在事件中明确标注"批量"</li>
     * </ul>
     *
     * @return 事件描述字符串
     */
