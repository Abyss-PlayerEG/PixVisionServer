...
CREATE TABLE `tb_content_audit_record` (
  ...
  `audit_reason` varchar(500) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT 'AI 审核判断依据',
  `insult_words` varchar(1000) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '命中敏感词，JSON数组字符串',
...
-- Dump completed on 2026-05-29 16:42:50
