...
(
  ...
  COLLATE = utf8mb4_german2_ci COMMENT ='评论表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='历史记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='赞赏表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='待审核数据表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_pending_reviews`
--

LOCK TABLES `tb_pending_reviews` WRITE;
/*!40000 ALTER TABLE `tb_pending_reviews`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_pending_reviews`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='作品系列';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `tb_series` WRITE;
/*!40000 ALTER TABLE `tb_series`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_series`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='收藏表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='系统操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_sys_logs`
--

LOCK TABLES `tb_sys_logs` WRITE;
/*!40000 ALTER TABLE `tb_sys_logs`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_sys_logs`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='用户数据表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_user_data`
--

LOCK TABLES `tb_user_data` WRITE;
/*!40000 ALTER TABLE `tb_user_data`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_user_data`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='作品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-10 17:47:31
