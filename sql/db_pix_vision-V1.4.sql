...
(
    ...
    `message`    varchar(512) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '消息内容',
    `project`    varchar(64) COLLATE utf8mb4_german2_ci  DEFAULT NULL COMMENT '消息主题',
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='消息列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_german2_ci COMMENT ='用户信息锁表，用于存放未过审的用户信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-15 20:08:09
