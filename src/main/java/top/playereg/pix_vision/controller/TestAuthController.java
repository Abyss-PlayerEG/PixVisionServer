 ...
 */
@RestController
@RequestMapping("/a77d3459da9d3bbeccd89e25311508d27af4ad9d46ee3d784204b4c3e5d07b5e")
@Tag(name = "JWT 鉴权测试接口")
public class TestAuthController {
    ...
    public ResponsePojo<String> requireAuth(HttpServletRequest request) {
        ...
        return ResponsePojo.success(
            String.format("欢迎访问！您已通过 JWT 认证。\\n用户 ID: %d\\n用户名：%s", userId, username),
            "认证成功"
        );
    }
